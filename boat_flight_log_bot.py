...
async def status(interaction: discord.Interaction):
    await interaction.response.send_message("✅ Boat Flight Log Bot is online and running.")

@bot.tree.command(name="flightstatus", description="Show current flight status.")
